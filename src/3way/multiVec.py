...
def vectorify(train,test,suff):
    ...
    pickle.dump(predCol,open("../../data/pipeLine/vectorData/predCol"+suff,"wb"))                
    ...
    pickle.dump(trainAfterFit,open("../../data/pipeLine/vectorData/trainAfterFit"+suff,"wb"))    
    
    testAfterFit = combineData[trainLen:]
    pickle.dump(testAfterFit,open("../../data/pipeLine/vectorData/testAfterFit"+suff,"wb"))
...
if __name__ == '__main__':
    ...
    for suff in senList:
        ...
        #train = pickle.load(open("../../data/pipeLine/train"+suff,"rb"))
        
        train = pd.read_csv("../../data/pipeLine/trainingData/train"+suff+".tsv", header=0, delimiter="\t", quoting=3)
